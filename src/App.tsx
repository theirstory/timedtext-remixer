                ...
                {(provided, snapshot) => (
                  ...
                  >
                    ...
                    {/* <p>
                      ...
                      Donec sed tincidunt lorem, ac ornare elit. Cras tincidunt
                      ipsum sed est sagittis volutpat. Morbi tempor ligula at
                      purus pulvinar luctus.
                    </p>
                    <Draggable draggableId="selection" index={0}>
                      {(provided, snapshot) => (
                        <>
                          ...
                          >
                            <p>
                              Curabitur quis porttitor nunc. Suspendisse
                              facilisis sed tellus quis mollis.{" "}
                              <span
                                className="selection"
                                {...provided.dragHandleProps}
                              >
                                Praesent ex eros, facilisis id imperdiet eget,
                                gravida sed neque.
                              </span>
                            </p>
                            <p>
                              <span
                                ...
                                {...provided.dragHandleProps}
                              >
                                Nunc dictum augue sapien, ut placerat nibh
                                interdum in. Cras odio ligula, posuere sit amet
                                commodo vel, auctor in nulla.
                              </span>
                            </p>
                            <p>
                              <span
                                ...
                                {...provided.dragHandleProps}
                              >
                                Etiam aliquet vestibulum urna tincidunt mollis.
                              </span>{" "}
                              Sed placerat libero et auctor fringilla. Aenean
                              pulvinar pulvinar arcu sed dignissim.
                            </p>
                          </div>
                          {snapshot.isDragging && (
                            <>
                              ...
                              >
                                <p>
                                  ...
                                  <span
                                    ...
                                    {...provided.dragHandleProps}
                                  >
                                    Praesent ex eros, facilisis id imperdiet
                                    eget, gravida sed neque.
                                  </span>
                                </p>
                                <p>
                                  <span
                                  ...
                                  >
                                    Nunc dictum augue sapien, ut placerat nibh
                                    interdum in. Cras odio ligula, posuere sit
                                    amet commodo vel, auctor in nulla.
                                  </span>
                                </p>
                                <p>
                                  <span
                                    ...
                                    {...provided.dragHandleProps}
                                  >
                                    Etiam aliquet vestibulum urna tincidunt
                                    mollis.
                                  </span>{" "}
                                  Sed placerat libero et auctor fringilla.
                                  Aenean pulvinar pulvinar arcu sed dignissim.
                                </p>
                              </div>
                            </>
                          )}
                    ...
                    <p>
                      Mauris porttitor sapien ac erat scelerisque tristique.
                      Maecenas eleifend magna eu nibh tempus eleifend. Vivamus
                      risus arcu, hendrerit nec sagittis vitae, malesuada id
                      enim. Phasellus ut orci condimentum, posuere felis vel,
                      viverra nisl.
                    </p> */}
